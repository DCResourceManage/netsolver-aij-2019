...
U_s = m.addVars(pn["Servers"].keys(), name="U_s", vtype=GRB.BINARY, obj=1.0)
...
serverMin = m.addConstrs((U_s[i] == max_(place.select('*', i)) for i in pn["Servers"].keys()), "serverMin")
