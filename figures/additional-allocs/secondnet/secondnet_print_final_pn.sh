...
for pn in ${pns[@]}; do
    ...
    for vn in ${vns[@]}; do
        ...
        final_pn_fname=final.${pn_name}.${vn}.pn
        ...
        echo +++ completed: $cmd 
        echo --- moving /tmp/instance_final to ${final_pn_path}/${final_pn_fname}
        mv /tmp/instance_final ${final_pn_path}/${final_pn_fname}
